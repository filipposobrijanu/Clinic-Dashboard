...
<title>Προσθήκη Ιατρού | MedicalAppointments</title>
<link
...
<div class="d-flex align-items-center vh-100">
		<div class="container mt-5">
			<div class="card shadow p-4 rounded-5">
				...
				<form action="AdminRegisterDoctorServlet" method="post">
								...
								<div class="mb-3">
									<label class="form-label">Όνομα *</label> <input
										type="text" name="name" class="form-control rounded-4"
										required placeholder="Κωδικός">
								</div>
								<div class="mb-3">
									<label class="form-label">Επώνυμο *</label> <input
										type="text" name="surname" class="form-control rounded-4"
										required placeholder="Κωδικός">
								</div>
								<div class="mb-4">
									<label class="form-label">Ειδικότητα *</label> <input
										type="text" name="specialty" class="form-control rounded-4"
										required placeholder="Κωδικός">
								</div>
