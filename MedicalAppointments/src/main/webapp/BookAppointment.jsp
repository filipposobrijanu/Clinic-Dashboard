...
<html>
<head>
<title>Κλείσιμο Ραντεβού | MedicalAppointments</title>
<link
		...
		<div class="container mt-5">
			<div class="card shadow p-4 rounded-5">
				...
				<form action="BookAppointmentServlet" method="post">
					<div class="mb-3">
						<label class="form-label">Ημερομηνία κ Ώρα (π.χ.
							2025-05-30 14:00)</label> <input type="text" name="datetime"
							class="form-control rounded-4" required>
					</div>
					<div class="mb-3">
						<label class="form-label">ID Ιατρού</label> <input type="number"
							name="doctor_id" class="form-control rounded-4" required>
					</div>
