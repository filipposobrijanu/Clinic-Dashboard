	...
	<div class="d-flex align-items-center vh-100">
		<div class="container">
			<div class="row text-center justify-content-center">
			    ...
			    <h1>🚫 404 - Η σελίδα δεν βρέθηκε</h1><br>
			    <p>Η σελίδα που προσπαθήσατε να ανοίξετε δεν υπάρχει ή έχει μετακινηθεί.</p><br>
			    <a href="login.jsp">Επιστροφή στην αρχική σελίδα</a>
			    		    </div>
		    </div>
	    </div>
    </div>
