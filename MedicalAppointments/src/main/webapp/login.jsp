	...
	<div class="d-flex align-items-center  vh-100">
		<div class="container">
				...
				<div class="col-md-7">
					<div class="card  shadow p-2 rounded-5">
						...
						<div
							...
							style="background: linear-gradient(-55deg, #aba4f5 0%, #6556FE 35%, #6556FE 65%, #aba4f5 100%); text-shadow: 0 0 10px #1b1744, 0 0 20px #1b1744;">
							<div class="fs-4">
								<b>Σύνδεση</b> Χρήστη
							</div>
						</div>
			...
			<div class=" sticky-bottom">
				<div class="row text-white justify-content-center p-3"
					style="background-color: #1b1744; font-size: 0.8rem;">
					<div class="col-auto">
						<div>
							<a href="https://www.unipi.gr">Unipi Website</a>
						</div>
					</div>
					<div class="col-auto">
						<div>
							<a href="contact.jsp">Επικοινωνία</a>
						</div>
					</div>
				</div>
			</div>
